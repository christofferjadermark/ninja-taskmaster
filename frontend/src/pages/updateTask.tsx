...
function App() {
  ...
  return (
    <div>
      ...
      <form className="mx-auto rounded-md text-[20px] " onSubmit={handleSubmit}>
        <div className="flex h-[60px] bg-gradient-to-b from-linear1  to-linear2">
          <input
            className="my-auto ml-[10%] w-full border-none bg-transparent pl-0 text-[30px] text-white placeholder:text-white focus:outline-none"
            type="text"
            id="title"
        ...
        <div className="mx-auto w-[80%]">
          ...
          <div className=" mt-[20px]  border-[1px] border-gray-300"></div>
          <div className=" mt-[20px] flex " onClick={handleClick}>
            <img src={burger} alt="" />
          ...
          >
            <textarea
              ...
              className="  mt-[20px] h-[180px]  resize-none rounded-[25px] border-[1px] border-secondary px-2 py-1 pl-[33px] text-gray-800 placeholder:text-[16px] focus:outline-none"
            ></textarea>
          </div>
          <div className=" mt-[20px]  border-[1px] border-gray-300"></div>
          <div className=" mt-[20px] flex " onClick={handleCategoryClick}>
          ...
          >
            ...
            >
              <div className=" h-[25px] w-[25px] rounded-full border-[2px] border-black bg-[#F17B25] "></div>
            ...
            >
              <div className=" h-[25px] w-[25px] rounded-full border-[2px] border-black bg-[#A3CDFF] "></div>
            ...
            >
              <div className=" h-[25px] w-[25px] rounded-full border-[2px] border-black bg-[#017A5D]"></div>
            ...
            >
              <div className=" h-[25px] w-[25px] rounded-full border-[2px] border-black bg-[#fffff]"></div>
          ...
          <div className=" mt-[20px]  border-[1px] border-gray-300"></div>
          <div className="form-group  mt-[20px] flex ">
          ...
          <div
            ...
            }  mt-[20px] flex w-[170px] cursor-pointer items-center rounded-[25px] border-[1px] border-secondary px-4 py-2`}
          >
          ...
          <div className="flex justify-between">
            <div
              onClick={() => setDeletePopup(!deletePopup)}
              className=" mt-[20px] flex cursor-pointer items-center rounded-[25px] border-[1px] border-secondary px-4 py-2"
            >
            ...
            >
              ...
              <div className="mt-[20px] text-[16px]">
                Are you sure you want to erase this task from the earth's
                surface?
              </div>
