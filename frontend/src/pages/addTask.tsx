...
function App() {
  ...
  return (
    <div>
      ...
      <form
        className="mx-auto  rounded-md text-[20px] "
      ...
      >
        ...
        <div className="mx-auto w-[80%]">
          ...
          >
            ...
            >
              <div className=" h-[25px] w-[25px] rounded-full border-[2px] border-black bg-[#FFC107]"></div>
          ...
          <input
            type="submit"
            value="Save"
            className="text-primary ml-auto  mt-[20px] flex cursor-pointer items-center rounded-[25px] bg-secondary px-6 py-2 text-white"
          />
        </div>
      </form>
    </div>
