...
const updateOverdueTasksWithOffset = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
// POSTS
app.post('/changeAccount', (request, response) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      yield pool
        ...
        .catch((error) => {
          ...
          response
            .status(500)
            .send('Ett fel uppstod vid uppdatering av kontot.');
        });
    } catch (error) {
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      if (result.rows.length > 0) {
        ...
        response
          .status(401)
          .json({ message: 'Ogiltiga inloggningsuppgifter.' });
      }
    } catch (error) {
      console.error('Fel vid anslutning:', error);
      response
